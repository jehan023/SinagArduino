...
#define PV_VoltagePin A1
#define PV_CurrentPin A6
#define BAT_VoltagePin A3
#define BAT_CurrentPin A7
...
void LDR() {
  ...
  if (ldrValue > 400 && ldrValue < 500)  //checks if ambient light is normal
  {
    Serial.print(ldrValue);
    Serial.println(" Ambient light intensity is normal.");
  } else if (ldrValue > 0 && ldrValue <= 400)  //checks if ambient light is too bright
  {
    Serial.print(ldrValue);
    Serial.println(" The environment is too bright.");
  } else if (ldrValue >= 500)  //checks of no ambient light (dark)
  {
    Serial.print(ldrValue);
    Serial.println(" The environment is too dark.");
  }
}
...
void onReceive(int packetSize) {
  ...
  if (Val == 10) {
    ReadSensors();
    Mymessage = Mymessage + pv_avg_volts + "," + pv_power + "," + bat_avg_volts + "," + batt_level + "," + bat_power + "," + led_status + "," + avg_temp + "," + avg_lux;
